...
export declare const subscribe$: (unsubscribes: Unsubscribe[] | undefined, reactives: Reactive<any>[] | undefined, action: () => void) => void;
export declare const combineReactive$: <T>(unsubscribes: Unsubscribe[] | undefined, reactives: Reactive<any>[] | undefined, func: () => T) => Reactive<T>;
