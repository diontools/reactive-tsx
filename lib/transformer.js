...
function transformSourceFile(ctx, typeChecker, sourceFile) {
    ...
    if (isMono) {
        ...
        let newStatements = transformedSourceFile.statements.filter((s, i) => i !== importStatementIndex);
        ...
        for (const statement of mainModuleFile.statements) {
            if (ts.isVariableStatement(statement)
                && ((_d = (_c = statement.modifiers) === null || _c === void 0 ? void 0 : _c.findIndex(m => m.kind === ts.SyntaxKind.ExportKeyword)) !== null && _d !== void 0 ? _d : -1) >= 0) {
