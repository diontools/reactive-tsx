...
exports.conditional$ = (unsubscribes, reactives, condition, tureReactives, trueCreate, falseReactives, falseCreate, onUpdate) => {
    ...
    exports.subscribe$(unsubscribes, reactives, () => {
        ...
        if (current !== next) {
            ...
            reactives ? exports.subscribe$(unsubs, reactives, update) : update();
            current = next;
        }
    });
};
exports.conditionalText$ = (unsubscribes, conditionReactives, condition, trueString, falseString, onUpdate) => {
    let current;
