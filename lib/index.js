...
exports.text = exports.element = exports.mapArray$ = exports.conditionalText$ = exports.conditional$ = exports.combineReactive$ = exports.subscribe$ = exports.reactiveArray = exports.reactive = void 0;
...
exports.subscribe$ = (action, unsubscribes, reactives) => {
    if (reactives) {
...
exports.combineReactive$ = (func, unsubscribes, reactives) => {
    const r = exports.reactive(undefined);
    exports.subscribe$(() => r.value = func(), unsubscribes, reactives);
    return r;
};
exports.conditional$ = (node, unsubscribes, reactives, condition, trueCreate, falseCreate) => {
...
exports.conditionalText$ = (node, unsubscribes, conditionReactives, condition, trueString, falseString) => {
    let current;
