...
export const reactiveArray = (init) => {
    let _v = init;
    const _actions = [];
    const _listeners = [];
...
export const subscribe = (action, unsubscribes, reactives) => {
    if (reactives) {
...
export const conditional = (node, unsubscribes, reactives, condition, trueCreate, falseCreate) => {
...
export const conditionalText = (node, unsubscribes, conditionReactives, condition, trueString, falseString) => {
    let current;
