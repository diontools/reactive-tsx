...
exports.text = exports.element = exports.mapArray = exports.conditionalText = exports.conditional = exports.subscribe = exports.reactiveArray = exports.reactive = void 0;
exports.reactive = function (init) {
    var _v = init;
    var _actions = [];
    return {
        get value() { return _v; },
...
exports.reactiveArray = function (init) {
    var _v = init;
    var _actions = [];
    var _listeners = [];
    var _holders = init.map(function (v, i) { return ({ item: exports.reactive(v), index: exports.reactive(i) }); });
    var length = exports.reactive(_v.length);
    ...
    return {
        ...
        push: function () {
            ...
            for (var i = 0; i < items.length; i++) {
                var index = _v.length;
                var holder = { item: exports.reactive(items[i]), index: exports.reactive(index) };
                _v.push(items[i]);
        ...
        splice: function (start, deleteCount) {
            ...
            for (var i = 0; i < replaceCount; i++) {
                ...
                _holders[start + i] = { item: exports.reactive(v), index: exports.reactive(start + i) };
                raise(2, holder);
            }
            if (addCount > 0) {
                for (var i = 0; i < addCount; i++) {
                    ...
                    _v.splice(index, 0, v);
                    var holder = { item: exports.reactive(v), index: exports.reactive(index) };
...
exports.subscribe = function (action, unsubscribes, reactives) {
    if (reactives) {
...
exports.conditional = function (node, unsubscribes, reactives, condition, trueCreate, falseCreate) {
...
exports.conditionalText = function (node, unsubscribes, conditionReactives, condition, trueString, falseString) {
    var current;
